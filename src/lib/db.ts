...
// Force rebuild v3 - scanLog.count added
...
class DatabaseClient {
  ...
  participant = {
    ...
    findMany: async (args?: { where?: Record<string, unknown>; orderBy?: Record<string, string>; take?: number; skip?: number; select?: string }) => {
      const client = this.getClient()
      let query = client.from('Participant').select(args?.select || '*')
  ...
  // CheckIn operations
  checkIn = {
    findMany: async (args?: { where?: Record<string, unknown>; orderBy?: Record<string, string>; take?: number; select?: string }) => {
      const client = this.getClient()
      let query = client.from('CheckIn').select(args?.select || '*')
  ...
  menuCategory = {
    ...
    updateMany: async (args: { where: Record<string, unknown>; data: UpdateTables<'MenuCategory'> }) => {
      const client = this.getClient()
      let query = client.from('MenuCategory').update(args.data)
  ...
  claim = {
    findMany: async (args?: { where?: Record<string, unknown>; orderBy?: Record<string, string>; take?: number; select?: string }) => {
      const client = this.getClient()
      let query = client.from('Claim').select(args?.select || '*')
  ...
  scanLog = {
    findMany: async (args?: { where?: Record<string, unknown>; orderBy?: Record<string, string>; take?: number }) => {
      const client = this.getClient()
      let query = client.from('ScanLog').select('*')
    ...
    count: async (args?: { where?: Record<string, unknown> }) => {
      const client = this.getClient()
      let query = client.from('ScanLog').select('id', { count: 'exact', head: true })
