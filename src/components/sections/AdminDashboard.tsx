...
const menuItems = [
  ...
  { id: 'checkin', label: 'Check-in Monitor', icon: CheckCircle, color: 'from-emerald-500 to-emerald-600' },
  ...
  { id: 'claims', label: 'Claims Activity', icon: Receipt, color: 'from-pink-500 to-pink-600' },
                        ...
                        >
                          ...
                          <CardContent>
                            <CardDescription className="text-slate-500 dark:text-slate-400">
                              ...
                              {item.id === 'checkin' && 'Monitor check-in real-time'}
                              {item.id === 'menu' && 'Kelola menu makanan & minuman'}
                              {item.id === 'booths' && 'Kelola booth klaim'}
                              {item.id === 'claims' && 'Riwayat aktivitas klaim'}
